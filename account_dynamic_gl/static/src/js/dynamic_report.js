...
var ControlButtons = Widget.extend({
	...
	download_pdf : function(event){
        ...
        var a_pdf = rpc.query({
                args: [filter,'pdf'],
                model: 'report.account.dynamic.report_general_ledger',
                method: 'render_html',
            }).then(function(result){
                var action = {
                    'type': 'ir.actions.report',
                    'report_type': 'qweb-pdf',
                    'report_name': 'accounting_pdf_reports.report_general_ledger',
                    'report_file': 'accounting_pdf_reports.report_general_ledger',
                    'data': result,
