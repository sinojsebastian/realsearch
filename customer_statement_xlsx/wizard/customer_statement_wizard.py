...
class CustomerStatementReportXlsx(models.TransientModel):
    
    _name = 'customer.statement.report.xlsx'
    _description = 'Customer Statement Xlsx'
    ...
    def print_customer_statement(self):
        ...
        return self.env.ref('customer_statement_xlsx.report_customer_statement_xlsx').report_action(self,data=datas)
