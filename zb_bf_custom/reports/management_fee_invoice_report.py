...
class ManagementFeeInvoiceReportQWeb(models.AbstractModel):

    _name = 'report.zb_bf_custom.management_fee_invoice_report'
    _description='Model For management fee in  Invoice'
