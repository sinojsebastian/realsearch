...
class TaxInvoiceReportQWeb(models.AbstractModel):

    _name = 'report.zb_bf_custom.tax_invoice_report'
    _description='Model For Tax Invoice'
...
#             for line in invoice.invoice_line_ids:
        ...
        print('==================ren_journal_id',int(rent_invoice_journal_id))
        return {
            'doc_ids': docids,
            'bank_data' : bank_dict,
            'words':word,
            'rent_journal':int(rent_invoice_journal_id),
