...
class TenantAdvanceDepositeInvoiceReportQWeb(models.AbstractModel):

    _name = 'report.zb_bf_custom.tenant_advance_deposit_invoice'
    _description='Tenant Advance Deposit Details Report'
