...
#     _name = 'report.zb_vat_report.report_vat_template'
# 
# 
...
#         for opt in options:
#             self.with_context(date_from=opt['from_date'], date_to=opt['to_date'], strict_range=True)._compute_from_amls(options, taxes)
#         
